...
knitr::kable(summary_PM25,caption = "Mean Particulates (2.5mm)", col.names = c("County", "µg/m3"))
knitr::kable(summary_Ozone, caption = "Mean Ozone", col.names = c("County", "µg/m3"))
```
...
``` {r 2018 Ozone Levels, echo=FALSE, results='hide', fig.align='left', fig.height=5, fig.cap='2018 Ozone values by month'}

# Dataframe for subset of records collected in 2018 
Ozonedata_2018 <- subset(epa_data, Year == 2018)


# Create the boxplot of distribution of Ozone levels by month using only records collected in 2018 
boxplot(Ozone ~ Month, data = Ozonedata_2018, xlab = "Month", ylab = "Concentration (µg/m3)", names =c("Jan", "Feb", "Mar", "Apr", "May", "Jun","Jul", "Aug", "Sep", "Oct", "Nov", "Dec"), main = "Ozone Levels - 2018")

```

``` {r 2019 Ozone Levels, echo=FALSE, results='hide', fig.align='left', fig.height=5, fig.cap='2019 Ozone values by month'}
# Dataframe for subset of records collected in 2018 
Ozonedata_2019 <- subset(epa_data, Year == 2019)

# Creating boxplot of distribution of Ozone levels by month using only records collected in 2019 
boxplot(Ozone ~ Month, data = Ozonedata_2019, xlab = "Month", ylab = "Concentration (µg/m3)",names =c("Jan", "Feb", "Mar", "Apr", "May", "Jun","Jul", "Aug", "Sep", "Oct", "Nov", "Dec"),  main = "Ozone Levels - 2019")
