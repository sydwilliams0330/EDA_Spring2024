...
chemistry_physics_rawdata$sampledate <- ymd(chemistry_physics_rawdata$sampledate)
...
july_scatter_plot <- ggplot(data = july_data_2, aes(x = depth, y = temperature_C)) +
  geom_point(color = "purple", alpha = 0.5) +  
  geom_smooth(method = "lm", se = FALSE, color = "red") +  
  labs(x = "Depth", y = "Temperature (°C)",  # Axes labels
       title = "Relationship between Depth and Temperature",  
       caption = "Data Source: NTL-LTER dataset") + 
...
temperature.model <- step(lm(temperature_C ~ year4 + daynum + depth, data = july_data_2))
...
NTERbest.regression <- lm(temperature_C ~ year4 + daynum, data = july_data_2)

summary(NTERbest.regression)
...
# Subset temperature data for each lake
temperature_crampton <- july_data_crampton_ward$temperature_C[july_data_crampton_ward$lakename == "Crampton Lake"]
temperature_ward <- july_data_crampton_ward$temperature_C[july_data_crampton_ward$lakename == "Ward Lake"]

# Perform two-sample t-test
t_test_result <- t.test(temperature_crampton, temperature_ward)

# Print t-test result
print(t_test_result)
```

>Answer: The mean temperatures for Crampton Lake and Ward Lake are similar with Crampton with a mean of 14 degrees and Ward with a mean of 12 degrees. 
